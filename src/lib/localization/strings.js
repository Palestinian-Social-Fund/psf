const strings = {
  ...
  ar: {
    ...
    strategy_splash_content: 'يتم توزيع الأموال الخيرية بنشر متناثر في العادة لتنويع الجهود الخيرية وإن هذا عكس فكرنا، فتُركّز استثمارات الصندوق حول استيعاد قوة القطاع الزراعي قرية قرية. في حين ما نملك لقمة عيشنا تُصبح كل قرية جزيرة اقتصادية تملك قوة انتاجية.',
