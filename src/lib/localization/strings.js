const strings = {
  en: {
    ...
    // Home page
    splash_title: 'Support the framework for Palestinian economic independence',
    splash_content: 'The future might seem bleak, but we believe differently. The PSF is dedicated to revitalizing the Palestinian economy one village at a time. With economic independence, we achieve political sovereignty.',
    ...
    value_title_1: 'Self-sufficiency',
    value_content_1: 'Lifting our dependence on imports and building independent villages through localized production.',
    value_title_2: 'Cooperativism',
    value_content_2: 'Cementing a foundation for true democratic values by employing the one-share-one-vote model.',
    value_title_3: 'Transparency',
    value_content_3: 'Open-sourcing the PSF\'s intellectual property and investment activity to lead honest development of our collective goal.',
  ...
  ar: {
    ...
    // Home page
    splash_title: 'لدعم هيكل تنظيمي يعمل لأجل الاستقلال الاقتصادي الفلسطيني',
    splash_content: 'قد يبدو المستقبل قاتمًا ، لكننا نعتقد بشكل مختلف. يكرس الصندوق الاجتماعي الفلسطيني جهوده لتنشيط الاقتصاد الفلسطيني قرية تلو الأخرى. بالاستقلال الاقتصادي نحقق السيادة السياسية. ',
    green_title: 'القوة في رقمنا',
    green_text: 'إن الصندوق الاجتماعي الفلسطيني حشد المصادر ومخصص لبناء شبكة من التعاونيات لإعادة قوة الإنتاج إلى الناس.',
    value_title_1: 'الاكتفاء الذاتي',
    value_content_1: 'رفع اعتمادنا على الواردات وبناء قرى مستقلة من خلال الإنتاج المحلي.',
    value_title_2: 'التعاونية',
    value_content_2: 'ترسيخ أسس القيم الديمقراطية الحقيقية من خلال استخدام نموذج الصوت الواحد للسهم الواحد.',
    value_title_3: 'الشفافية' ,
    value_content_3: 'فتح مصادر نشاط الملكية الفكرية والاستثمار في الصندوق الاجتماعي الفلسطيني لقيادة التنمية الصادقة لهدفنا الجماعي.',
