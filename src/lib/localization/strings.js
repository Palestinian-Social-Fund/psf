const strings = {
  en: {
    ...
    home_value2_content: 'Cementing a foundation for true democratic values by employing the one-share-one-vote model.',
    home_value3_title: 'Transparency',
    home_value3_content: 'Open-sourcing the PSF\'s software and investment activity to lead honest development of our collective goal.',
    home_feature_title: 'Crowdsourcing capital and investing in the agricultural sector',
    ...
    support_content: 'Create your membership to help revitalize the Palestinian economy.',
    ...
    strategy_step3_content: 'After a cooperative\'s operation is deemed sustainable, we directly replicate it in other villages. This saves us time and allows us to scale at lightning speed.',
    ...
    principles_splash_content: 'Our economy is currently dependent on foreign aid and imports, a great indicator for a brittle economic foundation. The PSF is building a foundational base upon unshakeable pillars that guarantees sustainable growth. Palestine can be an oasis against all odds.',
    ...
    principles_cooperativism_content: 'For increasing equity ownership amongst Palestinians and ensuring democratic values through equal representation.',
    principles_transparency_title: 'Transparency: open-sourcing software and funding activity',
    principles_transparency_content: 'For maintaining focus on collective goals and fostering the trust of our members and the public at large.',

    // Footer
    footer_home: 'Home',
    footer_principles: 'Principles',
    footer_strategy: 'Strategy',
  ...
  ar: {
    ...
    home_splash_title: 'لدعم هيكل استقلال الاقتصاد الفلسطيني',
    home_splash_content: 'الصندوق الاجتماعي الفلسطيني منظمة غير ربحية تستثمر في إعادة تنعيش الاقتصاد الفلسطيني أموالها المحصولة جماهيرياً قرية وراء قرية.',
    home_value1_title: 'الاكتفاء الذاتي',
    home_value1_content: 'إزالة اعتمادنا على الاستيراد وإقام استقلال القرى على الانتاج المحلي.',
    home_value2_title: 'التعاونية',
    home_value2_content: 'تأسيس القيم الديمقراطية الحقيقية على نموذج صوت واحد سهم واحد.',
    home_value3_title: 'الشفافية',
    home_value3_content: 'فتح مصدر برمجيات وأعمال الصندوق والتركيز على الهدف الجماعي بطريقة صالحة صادقة.',
    home_feature_title: 'تحصيل رأس المال جماهيرياً واستثماره في القطاع الزراعي',
    home_feature_content: 'أساس أي اقتصاد الزراعة، لكن معتمدة فلسطين اليوم على استيراد المواد الغذائية لذلك يهدف الصندوق الاجتماعي الفلسطيني الى استثمار كامل خزينته في توحيد وتنمية التعاونيات الزراعية، فامتلاك اقتصادنا يتبع امتلاك لقمة عيشنا.',
    support_title: 'اليوم للدعم',
    support_content: 'إنشاء عضوية لدعم تنعيش الاقتصاد الفلسطيني.',
    support_fund: 'دعم الصندوق',
    strategy_more: 'المزيد عن الاستراتيجية',
    principles_more: 'المزيد عن المبادئ',

    // Strategy page
    strategy_header_title: 'الاستراتيجية - الصندوق الاجتماعي الفلسطيني',
    strategy_splash_title: 'طليعة الاستثمار المُركّز',
    strategy_splash_subtitle: 'استراتيجية الصندوق',
    strategy_splash_content: 'يتم توزيع الأموال الخيرية بنشر متناثر في العادة لتنويع الجهود الخيرية وإن هذا عكس فكرنا، فتُركّز استثمارات الصندوق حول استيعادة قوة القطاع الزراعي قرية قرية. في حين ما نملك لقمة عيشنا تُصبح كل قرية جزيرة اقتصادية تملك قوة انتاجية.',
    strategy_step1_title: '1. دعم التعاونيات الزراعية',
    strategy_step1_content: 'يتم منح التمويل بمبلغ ينسب حاجة التعاونية وأهداف الصندوق لأيٍ من التعاونيات الناشأة أم القائمة.',
    strategy_step2_title: '2. تنمية التعاونيات بالعمل على الأرض',
    strategy_step2_content: 'كل تعاونية تستفيد من مساعدتنا المباشرة في تحسين أعمالها اللوجستية لكي تُصبح الممون الأساسي في منطقتها.',
    strategy_step3_title: '3. نسخ التعاونيات الناجحة في القرى الأخرى',
    strategy_step3_content: 'نقوم في القرى الأخرى بنسخ احدى التعاونيات بعد ضمان استدامتها العملية من أجل توفير الوقت والتوسع بسرعة البرق.',
    ...
    principles_splash_content: 'يعتمد اقتصادنا على المساعدات الخارجية والاستيراد حالياً فهذا مؤشر كبير على بنية تحتية اقتصادية ضعيفة. سيبني الصندوق الاجتماعي الفلسطيني قاعدة تأسيسية على أسس صلبة لا تهتز لكي نضمن النمو المستدام، فتكون فلسطين واحة رغم كل الصعاب.',
    principles_sufficiency_title: 'الاكتفاء الذاتي: تمركز الانتاج في بنيتنا الريفية',
    principles_sufficiency_content: 'لتملك كل قرية فلسطينية قدرة إنتاج حاجاتها الأساسية لتجنب مركزية السيطرة على الإنتاج.',
    principles_cooperativism_title: 'التعاونية: تحقيق الديمقراطية الحقيقية من خلال نموذج الصوت الواحد السهم الواحد',
    principles_cooperativism_content: 'لزيادة ملكية الأسهم بين الفلسطينيين وضمان القيم الديمقراطية من خلال التمثيل المتساوي.',
    principles_transparency_title: 'الشفافية: فتح مصدر البرمجيات والأعمال الاستثمارية',
    principles_transparency_content: 'لحفاظ التركيز على أهدافنا الجماعية وتعزيز ثقة أعضائنا والمجتمع العام.',

    // Footer
    footer_home: 'الصفحة الرأيسية',
    footer_principles: 'المبادئ',
    footer_strategy: 'الاستراتيجية',
